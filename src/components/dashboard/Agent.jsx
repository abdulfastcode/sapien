      ...
      <div>
        <table className="w-full table-auto ">
          <thead className="items-center border border-[#381E50]">
            <tr>
              <th className="text-base border border-[#381E50] font-bold  text-[#381E50]">ID</th>
              <th className="text-base border border-[#381E50] font-bold text-[#381E50]">Name</th>
              <th className="text-base border border-[#381E50] font-bold text-[#381E50]">Date</th>
              <th className="text-base border border-[#381E50] font-bold text-[#381E50]">Voice</th>
              <th className="pt-[3px]">
                <input
                  type="checkbox"
                  name=""
